  ...
  return (
    <div>
      ...
      <footer class="w-full text-emerald-500">
        {/* <!-- Main footer --> */}
        <div class="pt-16 pb-12 text-sm border-t border-emerald-200 bg-emerald-50">
          <div class="container px-6 mx-auto">
            <div class="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              >
                <h3
                  class="mb-6 text-base font-medium text-emerald-700"
        ...
        {/* <!-- Sub Footer --> */}
        <div class="py-4 text-sm border-t border-emerald-200/90 bg-emerald-100/80">
          <div class="container px-6 mx-auto">
            <div class="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              <nav
                ...
                class="col-span-2 text-right md:col-span-4 lg:col-span-6"
              >
                <h2 class="sr-only" id="footer-social-links-light">
                  Social Media Links
                </h2>
